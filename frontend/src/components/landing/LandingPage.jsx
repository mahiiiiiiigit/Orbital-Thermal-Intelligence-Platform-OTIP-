...
export function LandingPage({ onLaunchDashboard, onNavigateAnalytics, viewMode = 'dark', onToggleViewMode }) {
  return (
    <div className="min-h-screen w-full bg-dark-950 text-slate-100 flex flex-col selection:bg-orange-500/30 selection:text-orange-200">
